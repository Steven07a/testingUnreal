...
//#include "MPStream01.generated.h" // this is broken
//#include "MPStream01GameInstance.generated.h" // this is broken
#include "MPStream01GameInstance.generated.h"
...
class MPSTREAM01_API UMPStream01GameInstance : public UGameInstance
{
	GENERATED_BODY()
...
public:
	...
	void SendHttpRequest(const FString& Url, const FString& RequestContent, const FString& Verb);

	UFUNCTION(BlueprintCallable, Category = Http)
	void SendPostHttpRequest(const FString& Url, const FString& RequestContent,  
	...
	UPROPERTY(EditAnywhere)
	TSubclassOf<class AActor> BlueprintVar; // YourClass is the base class that your blueprint uses

	//static FORCEINLINE ObjClass* LoadBlueprintFromPath(const FName& Path, const FName& BlueprintName)
	//void ParseExample(const FString& JsonRaw);
